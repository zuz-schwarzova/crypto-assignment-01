...
'''
Creates two binary files (F.bin, F2.bin) of pseudorandom data with size 10^9 bits (125000000 bytes) in src directory.
...
def main():
    print('Started...')
    # creates a new binary file in src directory, F.bin
    fFile = open("F.bin", "wb")
    ...
    print('1/3 STEPS COMPLETED: \nF.bin created.')

    # creates a new binary file in src directory, F2.bin
    ...
    print('2/3 STEPS COMPLETED: \nF2.bin created.')

    # generates sha256 string hash for F.bin and prints it
    print('3/3 STEPS COMPLETED: \nF.bin\'s SHA256 hash is: ' + sha256sum('F.bin'))
    print('\nComplete!')
